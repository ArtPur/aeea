...
class ConnectionManager
{
	...
	{
		return $this->byId( "aeeaphprunner_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "aeeaphprunner_at_localhost";
		$data["connName"] = "aeeaphprunner at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;root;;aeeaphprunner;;1"; //currently unused
		
		$this->_connectionsIdByName["aeeaphprunner at localhost"] = "aeeaphprunner_at_localhost";
		...
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "aeeaphprunner";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=root;Database=aeeaphprunner;OPTION=3";
		...
		$connectionsData["aeeaphprunner_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["country"] = "aeeaphprunner_at_localhost";
		$connectionsIds["reps"] = "aeeaphprunner_at_localhost";
		$connectionsIds["school"] = "aeeaphprunner_at_localhost";
		$connectionsIds["school_type"] = "aeeaphprunner_at_localhost";
		$connectionsIds["School Report"] = "aeeaphprunner_at_localhost";
		$connectionsIds["reps Report"] = "aeeaphprunner_at_localhost";
		$connectionsIds["Student Report"] = "aeeaphprunner_at_localhost";
		$connectionsIds["provinces"] = "aeeaphprunner_at_localhost";
