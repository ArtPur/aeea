...
<?php } else { ?>
window.parent.Runner.Pdf.SetContent('<div style="width:500px;"><?php echo jsreplace("PDF file created. Download the file using this");?> <a href="getpdf.php?table=<?php echo GetTableURL();?>&id=<?php echo $outfileid;?>"><?php echo jsreplace("link");?></a></div>');
<?php } ?>
</script>
<div id="done"></div>
