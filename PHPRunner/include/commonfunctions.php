...
function checkTableName($shortTName, $type=false)
{
	...
	if ("country" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("reps" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("school" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("school_type" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("School_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("reps_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Student_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("provinces" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$strPerm = GetUserPermissions("reps");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="reps";
	}
	...
	$strPerm = GetUserPermissions("school_type");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="school_type";
	}
	$strPerm = GetUserPermissions("School Report");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="School Report";
	}
	$strPerm = GetUserPermissions("reps Report");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="reps Report";
	}
	$strPerm = GetUserPermissions("Student Report");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Student Report";
	}
...
function GetUserPermissionsStatic( $table )
{
	...
	if($table=="country" && $sUserGroup=="-1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="country" && $sUserGroup=="0")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="reps" && $sUserGroup=="-1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="reps" && $sUserGroup=="0")
	{
			return "E".$extraPerm;
	}
//	default permissions	
	...
	if($table=="school" && $sUserGroup=="-1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="school" && $sUserGroup=="0")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="school_type" && $sUserGroup=="-1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="school_type" && $sUserGroup=="0")
	{
			return "".$extraPerm;
	}
//	default permissions	
	if($table=="school_type")
	{
		return "".$extraPerm;
	}
	if($table=="School Report" && $sUserGroup=="-1")
	{
			return "SP".$extraPerm;
	}
	if($table=="School Report" && $sUserGroup=="0")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	if($table=="School Report")
	{
		return "SP".$extraPerm;
	}
	if($table=="reps Report" && $sUserGroup=="-1")
	{
			return "SP".$extraPerm;
	}
	if($table=="reps Report" && $sUserGroup=="0")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	if($table=="reps Report")
	{
		return "SP".$extraPerm;
	}
	if($table=="Student Report" && $sUserGroup=="-1")
	{
			return "SP".$extraPerm;
	}
	if($table=="Student Report" && $sUserGroup=="0")
	{
			return "SP".$extraPerm;
	}
//	default permissions	
	if($table=="Student Report")
	{
		return "SP".$extraPerm;
	}
	if($table=="provinces" && $sUserGroup=="-1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="provinces" && $sUserGroup=="0")
	{
			return "".$extraPerm;
	}
//	default permissions	
...
function AfterFBLogIn($pUsername, $pPassword, &$pageObject = null)
{
	...
	$strSQL = "select * from ".$connection->addTableWrappers("reps")
...
function SetAuthSessionData($pUsername, &$data, $fromFacebook, $password, &$pageObject = null)
{
	...
	$_SESSION["_country_OwnerID"] = $data["username"];
		$_SESSION["_reps_OwnerID"] = $data["username"];
		$_SESSION["_school_OwnerID"] = $data["username"];
		$_SESSION["_school_type_OwnerID"] = $data["username"];
		$_SESSION["_School Report_OwnerID"] = $data["username"];
		$_SESSION["_reps Report_OwnerID"] = $data["username"];
		$_SESSION["_Student Report_OwnerID"] = $data["rep_id"];
		$_SESSION["_provinces_OwnerID"] = $data["username"];
...
function CheckSecurity($strValue, $strAction)
{
	...
	{
		if($strTableName=="country")
		{
			
				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$strTableName."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($strTableName=="reps")
		{
			
				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$strTableName."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($strTableName=="school")
		{
			
				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$strTableName."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($strTableName=="school_type")
		{
			
				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$strTableName."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($strTableName=="School Report")
		{
			
				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$strTableName."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($strTableName=="reps Report")
		{
			
				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$strTableName."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($strTableName=="Student Report")
		{
			
				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$strTableName."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($strTableName=="provinces")
		{
