...
require_once("include/school_variables.php");
...
$layout = new TLayout("print", "Purific1GreenWave1", "MobileGreenWave1");
$layout->version = 2;
...
$page_layouts["school_print"] = $layout;
...
$layout = new TLayout("masterprint", "Purific1GreenWave1", "MobileGreenWave1");
$layout->version = 2;
...
$page_layouts["reps_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "school" );
