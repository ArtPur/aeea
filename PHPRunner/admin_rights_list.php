...
$pageMask[$table] = $mask;
$tables[$table] = array("school", " " . "School");
$table = "school_type";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("school_type", " " . "School Type");
$table = "users";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("School_Report", " " . "School Report");
$table = "reps Report";
$mask="";
	$mask .= "S";
$mask .= "P";
...
$pageMask[$table] = $mask;
$tables[$table] = array("reps_Report", " " . "Reps Report");
$table = "Student Report";
$mask="";
	$mask .= "S";
$mask .= "P";

$pageMask[$table] = $mask;
$tables[$table] = array("Student_Report", " " . "Student Report");
$table = "provinces";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("provinces", " " . "Provinces");




$layout = new TLayout("ug_rights", "Purific1GreenWave1", "MobileGreenWave1");
$layout->version = 2;
