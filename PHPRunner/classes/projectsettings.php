...
class ProjectSettings
{
	...
	*/
	...
	{
		return new ProjectSettings("reps", PAGE_LIST);
	}
...
function GetTableURL($table = "")
{
	...
	if("school" == $table) 
		return "school";
	if("school_type" == $table) 
		return "school_type";
	if("School Report" == $table) 
		return "School_Report";
	if("reps Report" == $table) 
		return "reps_Report";
	if("Student Report" == $table) 
...
{	
	...
	if("school" == $shortTName) 
		return "school";
	if("school_type" == $shortTName) 
		return "school_type";
	if("School_Report" == $shortTName) 
		return "School Report";
	if("reps_Report" == $shortTName) 
		return "reps Report";
	if("Student_Report" == $shortTName) 
