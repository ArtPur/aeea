...
require_once("include/School_Report_variables.php");
...
$page_layouts["School_Report_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=School_Report.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=School_Report.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("Representative_fieldheader", true);
$xt->assign("School_Name_fieldheader", true);
$xt->assign("Registration_Number_fieldheader", true);
$xt->assign("Registration_Date_fieldheader", true);
$xt->assign("School_Type_fieldheader", true);
$xt->assign("Administrator_fieldheader", true);
$xt->assign("Principal_fieldheader", true);
...
$xt->assign("School_Phone_fieldheader", true);
$xt->assign("Administrator_Cell_fieldheader", true);
$xt->assign("Total_Students_fieldheader", true);
$xt->assign("Longditude_fieldheader", true);
