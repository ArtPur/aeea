...
$layout = new TLayout("remind", "Purific1GreenWave1", "MobileGreenWave1");
$layout->version = 2;
...
if (@$_POST["btnSubmit"] == "Remind")
{
	...
	{	
		...
		if($tosearch)
		{
			...
			$strSQL = $selectClause." from ".$pageObject->connection->addTableWrappers("reps")." where ".$sWhere;
...
$layout = new TLayout("remind_success", "Purific1GreenWave1", "MobileGreenWave1");
$layout->version = 2;
$layout->blocks["top"] = array();
$layout->containers["fields"] = array();
$layout->container_properties["fields"] = array(  );
