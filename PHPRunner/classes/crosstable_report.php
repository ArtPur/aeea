...
class CrossTableReport
{
	...
	public function isProjectDB()
	{
		...
		$isDB = false;
		if("country" == $this->xml_array['tables'][0])
			$isDB = true;
		if("reps" == $this->xml_array['tables'][0])
			$isDB = true;
		if("school" == $this->xml_array['tables'][0])
			$isDB = true;
		if("school_type" == $this->xml_array['tables'][0])
			$isDB = true;
		if("school" == $this->xml_array['tables'][0])
			$isDB = true;
		if("reps" == $this->xml_array['tables'][0])
		...
		if("school" == $this->xml_array['tables'][0])
			$isDB = true;
		if("provinces" == $this->xml_array['tables'][0])
			$isDB = true;
		return $isDB;
	}
}
