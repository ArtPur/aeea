...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("reps");
}
...
class tDAL
{
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "aeeaphprunner_audit", "varname" => "aeeaphprunner_audit", "connId" => "aeeaphprunner_at_localhost");
		$this->lstTables[] = array("name" => "country", "varname" => "country", "connId" => "aeeaphprunner_at_localhost");
		$this->lstTables[] = array("name" => "provinces", "varname" => "provinces", "connId" => "aeeaphprunner_at_localhost");
		$this->lstTables[] = array("name" => "reps", "varname" => "reps", "connId" => "aeeaphprunner_at_localhost");
		$this->lstTables[] = array("name" => "school", "varname" => "school", "connId" => "aeeaphprunner_at_localhost");
		$this->lstTables[] = array("name" => "school_type", "varname" => "school_type", "connId" => "aeeaphprunner_at_localhost");
	}
